...
library LibArbitrumL2Upgradeable {
    ...
    function isCrossChain(address arbsys) internal view returns (bool) {
        return IArbSysUpgradeable(arbsys).wasMyCallersAddressAliased();
    }
    ...
    function crossChainSender(address arbsys) internal view returns (address) {
        ...
        return IArbSysUpgradeable(arbsys).myCallersAddressWithoutAliasing();
    }
}
...
library LibOptimismUpgradeable {
    ...
    function crossChainSender(address messenger) internal view returns (address) {
        ...
        return ICrossDomainMessengerUpgradeable(messenger).xDomainMessageSender();
    }
}
